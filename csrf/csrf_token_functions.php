...
// Return an HTML tag including the CRSF token for use in a form
...
// Returns true if the users-submitted POST token is
...
// Optional check to determine if CSRF token is recent
